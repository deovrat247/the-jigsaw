...
class Viral_video_maker_in_navi_mumbai extends CI_Controller {

	public function index()
	{
		//SEO METADATA
		$data['title'] = "Viral Video Maker | Viral Video Maker in Mumbai | Viral Video Maker in Navi Mumbai, Vashi";
		...
		$data['type'] = "amphtml";				$data['ogtype'] = "business.business";		$data['ogurl'] = "http://www.thejigsaw.in/viral-video-maker-in-navi-mumbai.html";		$data['ogimage'] = "http://www.thejigsaw.in/assets/images/viral-video.jpg";

		$this->load->view('template/header',$data);
		$this->load->view('template/navigation');
		$this->load->view('services/viral_video');
...
/* Location: ./application/controllers/viral_video-maker_in_navi_mumbai.php */
