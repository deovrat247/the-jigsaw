...
class Animation_in_3d_And_2d extends CI_Controller {

	public function index()
	{

		//SEO METADATA
		$data['title'] = "2d and 3d Animation | 2d and 3d Animation in Mumbai ";
		...
		$data['type'] = "amphtml";		$data['ogtype'] = "business.business";		$data['ogurl'] = "http://thejigsaw.in/Animation-in-3d-And-2d.html";		$data['ogimage'] = "http://www.thejigsaw.in/assets/images/commercial-film.jpg";

		$this->load->view('template/header',$data);
		$this->load->view('template/navigation');
		$this->load->view('services/Animation-in-3d-And-2d');		
