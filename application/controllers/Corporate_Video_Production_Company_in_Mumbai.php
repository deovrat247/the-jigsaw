...
class Corporate_Video_Production_Company_in_Mumbai extends CI_Controller {

	public function index()
	{
		//SEO METADATA
		$data['title'] = "Corporate Video Makers Mumbai | Corporate Video Production | Video Production Company";
...
ad film production houses in mumbai, indian production companies";
		...
		$data['type'] = "amphtml";				$data['ogtype'] = "business.business";		$data['ogurl'] = "http://www.thejigsaw.in/Corporate-Video-Production-Company-in-Mumbai.html";		$data['ogimage'] = "http://www.thejigsaw.in/assets/images/Corporate-Video.jpg";
		
		$this->load->view('template/header',$data);
		$this->load->view('template/navigation');
		$this->load->view('services/corporate_video_production');
