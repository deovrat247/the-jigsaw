<?php
		...
		class Ecommerce_Product_Photoshoot_in_Mumbai_hindi extends CI_Controller {
		
			public function index()
			{
				//SEO METADATA
				$data['title'] = "ईकॉमर्स उत्पाद फोटोशूट | ईकॉमर्स उत्पाद फोटोशूट इन मुंबई ";
				...
				$data['type'] = "amphtml";				$data['ogtype'] = "business.business";				$data['ogurl'] = "http://www.thejigsaw.in/Ecommerce-Product-Photoshoot-in-Mumbai-hindi.html";				$data['ogimage'] = "http://www.thejigsaw.in/assets/images/product-catalogue.jpg";

				$this->load->view('template/header',$data);
				$this->load->view('template/navigation');
				$this->load->view('services/product_photoshoot_hindi');		
		...
		/* Location: ./application/controllers/Ecommerce_Product_Photoshoot_in_Mumbai_hindi.php */		