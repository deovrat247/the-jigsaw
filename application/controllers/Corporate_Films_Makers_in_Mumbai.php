...
class Corporate_Films_Makers_in_Mumbai extends CI_Controller {

	public function index()
	{
		//SEO METADATA
		$data['title'] = "Corporate Films | Corporate Film Maker | Corporate Film Makers in Mumbai ";
		...
		$data['type'] = "amphtml";		$data['ogtype'] = "business.business";		$data['ogurl'] = "http://www.thejigsaw.in/Corporate-Films-Makers-in-Mumbai.html";		$data['ogimage'] = "http://www.thejigsaw.in/assets/images/corporate-films.jpg";

		$this->load->view('template/header',$data);
		$this->load->view('template/navigation');
		$this->load->view('services/corporate_film');		
...
/* Location: ./application/controllers/Corporate_Films_Makers_in_Mumbai.php */