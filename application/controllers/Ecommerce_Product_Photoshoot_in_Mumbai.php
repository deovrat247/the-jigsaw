<?php
		...
		class Ecommerce_Product_Photoshoot_in_Mumbai extends CI_Controller {
			...
			public function index()
			{
				...
				$data['type'] = "amphtml";				$data['ogtype'] = "business.business";				$data['ogurl'] = "http://www.thejigsaw.in/Ecommerce-Product-Photoshoot-in-Mumbai.html";				$data['ogimage'] = "http://www.thejigsaw.in/assets/images/product-catalogue.jpg";

				$this->load->view('template/header',$data);
				$this->load->view('template/navigation');
				$this->load->view('services/product_photoshoot');		
