...
class Products_Catalogue_in_Mumbai_hindi extends CI_Controller {

	public function index()
	{
		//SEO METADATA
		$data['title'] = "उत्पाद सूची | प्रोडक्ट कैटेलॉग इन मुंबई | प्रोडक्ट कैटेलॉग इन पुणे ";
		...
		$data['type'] = "amphtml";		$data['ogtype'] = "business.business";		$data['ogurl'] = "http://www.thejigsaw.in/Products-Catalogue-in-Mumbai-hindi.html";		$data['ogimage'] = "http://www.thejigsaw.in/assets/images/product-catalogue.jpg";

		$this->load->view('template/header',$data);
		$this->load->view('template/navigation');
		$this->load->view('services/product_catalogue_hindi');		
...
/* Location: ./application/controllers/Products_Catalogue_in_Mumbai_hindi.php */