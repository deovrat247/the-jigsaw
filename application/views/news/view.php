		...
		<div class="row">
			...
			<div class=" col-md-offset-1 col-lg-10 col-md-10 col-md-offset-1 padding-right-30">
				...
				<div class="blog-post single-post">
					...
					<!-- Img -->
					<img class="post-img" src="<?php echo $newss['image_path'];?>" alt="<?php echo $newss['title'];?>" style="width: 100%; height: 50%">
					
					<!-- Content -->
					<div class="post-content">
						<h3><?php echo $newss['title']; ?></h3>
						<ul class="post-meta">
							<li><?php echo $newss['pubdate']; ?></li>
							<li><a href="#"><?php echo $newss['category_id']; ?></a></li>
						</ul>
						<p><?php echo $newss['body']; ?></p>
